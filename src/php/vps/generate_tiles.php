...
if ($area_km2 > $max_area_km2) {
    echo json_encode(["error" => "TIFF の範囲が大きすぎます ($width_km km × $height_km km = $area_km2 km²)。最大許容サイズは 1km² です。"]);
    exit;
}
...
$tileCommand = "gdal2tiles.py -z 0-20 --s_srs EPSG:$sourceEPSG --xyz --processes=4 " . escapeshellarg($warpedFilePath) . " $escapedTileDir";
