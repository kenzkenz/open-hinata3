...
export const sicyosonChibanzuUrls = [
    // 北海道
    {prefname:'北海道', prefcode:'01', code:'01205', name:'室蘭市', chiban: ['get', '地番'], position:[140.99286678768675,42.36472347973418], url:'muroranshi', page:'https://murorancity-opendata-muroran.hub.arcgis.com/datasets/f5a188ea9ae94d7abd68983eb351aeff/explore?layer=3&location=42.368631%2C140.979326%2C12.64'},
    {prefname:'北海道', prefcode:'01', code:'01234', name:'北広島市', chiban: ['concat', ['get', 'Chiban'], '-', ['get', 'Edaban']], position:[141.56311494973653,42.98537981878215], url:'kitahiroshimashi2', page:'https://www.harp.lg.jp/opendata/dataset/2061.html'},
    {prefname:'北海道', prefcode:'01', code:'01204', name:'旭川市', chiban: ['get', 'TXTCD'], position:[142.36538083068262,43.77140401060319], url:'asahikawashi', page:'https://www.city.asahikawa.hokkaido.jp/kurashi/112/113/116/d080184.html'},
    {prefname:'北海道', prefcode:'01', code:'01395', name:'ニセコ町', chiban: ['get', '地番'], position:[140.68806409835815,42.80495731522012], url:'nisekocyo', page:'https://www.harp.lg.jp/opendata/dataset/1750.html'},
    {prefname:'北海道', prefcode:'01', code:'01631', name:'音更町', chiban: ['get', 'chiban'], position:[143.19816291534738,42.99393583189044], url:'otohukechyo', page:'https://www.harp.lg.jp/opendata/dataset/2035.html'},
    // 宮城県
    {prefname:'宮城県', prefcode:'04', code:'04100', name:'仙台市', chiban: ['get', 'DNO'], position:[140.86946408465997,38.26816199999661], url:'sendaishi', page:'https://www.geospatial.jp/ckan/dataset/chibanzu'},
    // 秋田県
    {prefname:'秋田県', prefcode:'05', code:'05209', name:'鹿角市', chiban: ['get', '地番'], position:[140.7886727460321,40.21559737412008], url:'kazunoshi', page:'https://www.city.kazuno.lg.jp/soshiki/somu/digital/gyomu/opendata/9788.html'},
    // 山形県
    {prefname:'山形県', prefcode:'06', code:'06363', name:'舟形町', chiban: ['get', 'TIBAN'], position:[140.32022099999745,38.691255021073715], url: 'funagatamachi', page:'https://www.town.funagata.yamagata.jp/s012/opendata/010/010/20230711101613.html'},
    // 福島県
    {prefname:'福島県', prefcode:'07', code:'07201', name:'福島市', chiban: ['get', 'TXTCD'], position:[140.47460922099737,37.76082999999447], url:'fukushimashi2', page:'https://www.city.fukushima.fukushima.jp/d-kikaku/shise/opendate/machidukuri.html'},
    // 茨城県
    {prefname:'茨城県', prefcode:'08', code:'08223', name:'潮来市', chiban: ['get', '地番'], position:[140.55540531603634,35.947116226224], url: 'itakoshi', page:'https://www.city.itako.lg.jp/opendata.php'},
    {prefname:'茨城県', prefcode:'08', code:'08564', name:'利根町', chiban: ['get', '地番'], position:[140.1391729153425,35.85756030920088], url: 'tonechyo', page:'https://www.town.tone.ibaraki.jp/opendata.php'},
    // 群馬県
    {prefname:'群馬県', prefcode:'10', code:'10202', name:'高崎市', chiban: ['get', '地番_地番図_label'], position:[139.00336683069094,36.32182569208747], url:'takasakishi', page:'https://www.city.takasaki.gunma.jp/page/3130.html'},
    // 埼玉県
    {prefname:'埼玉県', prefcode:'11', code:'11222', name:'越谷市', chiban: ['concat', ['get', '本番'], '-', ['get', '枝番']], position:[139.79105245767255,35.890609232668695], url:'koshigayashi', page:'https://www.city.koshigaya.saitama.jp/kurashi_shisei/kurashi/zeikin/koteisisan_tosikeikaku/tibanzu_opendate.html'},
    {prefname:'埼玉県', prefcode:'11', code:'11218', name:'深谷市', chiban: ['concat', ['get', '本番'], '-', ['get', '枝番']], position:[139.281707999998,36.197104580699204], url:'fukayashi', page:'https://opendata.pref.saitama.lg.jp/resources/6204'},
    // 東京都
    {prefname:'東京都', prefcode:'13', code:'13209', name:'町田市', chiban: ['get', 'CHIBAN'], position:[139.4387823343277,35.546591812173475], url:'machidashi', page:'https://www.city.machida.tokyo.jp/shisei/opendata/chizujoho/chisekizu.html'},
    {prefname:'東京都', prefcode:'13', code:'13211', name:'小平市', chiban: ['get', '表示地番'], position:[139.47753045767575,35.728369484747276], url:'kodairashi', page:'https://www.city.kodaira.tokyo.jp/kurashi/111/111978.html'},
    {prefname:'東京都', prefcode:'13', code:'13213', name:'東村山市', chiban: ['get', 'TXTCD'], position:[139.4687322037018,35.75465000000037], url:'higashimurayamashi', page:'https://catalog.data.metro.tokyo.lg.jp/dataset/t132136d0000000005'},
    {prefname:'東京都', prefcode:'13', code:'13215', name:'国立市', chiban: ['get', '表示文字列'], position:[139.44141245767452,35.68379371055923], url:'kunitachishi3', page:'https://www.city.kunitachi.tokyo.jp/soshiki/Dept01/Div03/Sec01/oshirase/11883.html'},
    // 山梨県
    {prefname:'山梨県', prefcode:'19', code:'19201', name:'甲府市', chiban: ['get', '地番'], position:[138.56829800000241,35.66205666308586], url:'kofushi', page:'https://kofu.geocloud.jp/webgis/?p=0&bt=0&mp=337-1&'},
    // 静岡県
    ...
    {prefname:'京都府', prefcode:'26', code:'26207', name:'城陽市', chiban: ['get', 'chiban'], position:[135.7800419153457,34.85309321719859], url:'jyoyoshi', page:'https://data.bodik.jp/dataset/262072_koteishisanzeichibanzu/resource/8f5c8de3-f574-45b4-9291-3791ffa41407'},
    {prefname:'京都府', prefcode:'26', code:'26209', name:'長岡京市', chiban: ['get', '表示文字列'], position:[135.69535828836183,34.926424814234565], url:'nagaokakyoshi', page:'https://www.city.nagaokakyo.lg.jp/0000012991.html'},
    {prefname:'京都府', prefcode:'26', code:'26303', name:'大山崎町', chiban: ['get', '所在'], position:[135.68867837302201,34.902743804081595], url:'oyamasakichyo', page:'https://www.town.oyamazaki.kyoto.jp/annai/zeijyuminka/zeimukakari/chozei/koteisisanzei/5857.html'},
    // 大阪府
    {prefname:'大阪府', prefcode:'27', code:'27202', name:'岸和田市', chiban: ['get', 'CHIBAN'], position:[135.37090737539307,34.46054514396512], url:'kishiwadashi', page:'https://www.city.kishiwada.osaka.jp/soshiki/16/tochi-chibankrnnsakuichiranhyou.html'},
    {prefname:'大阪府', prefcode:'27', code:'27228', name:'泉南市', chiban: ['get', '表示文字列'], position:[135.2734460647299,34.36591222577401], url:'sennanshi', page:'https://www.city.sennan.lg.jp/kakuka/soumu/zeimuka/kazeikakari/zeikin/koteishisan/1505179465186.html'},
    ...
    {prefname:'奈良県', prefcode:'29', code:'29210', name:'香芝市', chiban: ['get', '地番名称'], position:[135.69894062698785,34.5410982491169], url:'kashibashi', page:'https://www.city.kashiba.lg.jp/soshiki/5/31946.html'},
    // 岡山県
...
const amx2024Source = {
    id: "amx-a-2024-pmtiles", obj: {
        type: "vector",
        // url: 'custom-pmtiles://https://kenzkenz3.xsrv.jp/pmtiles/amx/MojMap_amx_2024.pmtiles'
