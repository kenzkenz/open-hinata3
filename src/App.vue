  ...
  <v-app>
    <v-main>
      ...
      <div v-if="isJobMenu"
        ...
        <!-- 業務を終了 -->
        <MiniTooltip text="JOBを終了" :offset-x="0" :offset-y="0">
          <v-btn
              icon
              size="small"
        ...
        <!-- Job Picker を開く -->
        <MiniTooltip text="JOBを選ぶ / 変更する" :offset-x="0" :offset-y="0">
          <v-btn
              icon
              size="small"
              color="primary"
...
export default {
  ...
  methods: {
    ...
    async updatePointNameOnServer (pointId, newName) {
      ...
      fd.append('action', 'job_points.rename')
      fd.append('point_id', String(pointId))
      fd.append('point_name', newName) // 今後“_方式”に揃えるならここで正規化
